...
export const geometries = {
  phone: { columns: 8, rows: 7, nowColumn: 3, lockAhead: 2, font: 8 },
  tablet: { columns: 20, rows: 12, nowColumn: 6, lockAhead: 5, font: 9 },
  desktop: { columns: 28, rows: 16, nowColumn: 8, lockAhead: 7, font: 10.5 },
} satisfies Record<string, Geometry>;

export type GeometryName = keyof typeof geometries;

/** Height of the time-offset strip above the grid, per the design file. */
export const TIME_STRIP_HEIGHT = 13.5;
